...
foreign import CALLCV "alEnable"
  alEnable
    :: ALenum -- ^ capability
    -> IO ()

foreign import CALLCV "alDisable"
  alDisable
    :: ALenum -- ^ capability
    -> IO ()

foreign import CALLCV "alIsEnabled"
  alIsEnabled
    :: ALenum -- ^ capability
    -> IO ()
...
foreign import CALLCV "alGetString"
  alGetString
    :: ALenum          -- ^ param
    -> IO (Ptr ALchar)

foreign import CALLCV "alGetBooleanv"
  alGetBooleanv
    :: ALenum        -- ^ param
    -> Ptr ALboolean -- ^ data
    -> IO ()

foreign import CALLCV "alGetIntegerv"
  alGetIntegerv
    :: ALenum    -- ^ param
    -> Ptr ALint -- ^ data
    -> IO ()

foreign import CALLCV "alGetFloatv"
  alGetFloatv
    :: ALenum      -- ^ param
    -> Ptr ALfloat -- ^ data
    -> IO ()

foreign import CALLCV "alGetDoublev"
  alGetDoublev
    :: ALenum       -- ^ param
    -> Ptr ALdouble -- ^ data
    -> IO ()

foreign import CALLCV "alGetBoolean"
  alGetBoolean
    :: ALenum       -- ^ param
    -> IO ALboolean

foreign import CALLCV "alGetInteger"
  alGetInteger
    :: ALenum   -- ^ param
    -> IO ALint

foreign import CALLCV "alGetFloat"
  alGetFloat
    :: ALenum     -- ^ param
    -> IO ALfloat

foreign import CALLCV "alGetDouble"
  alGetDouble
    :: ALenum      -- ^ param
    -> IO ALdouble
...
foreign import CALLCV "alGetError"
  alGetError :: IO ALenum



foreign import CALLCV "alIsExtensionPresent"
  alIsExtensionPresent
    :: Ptr ALchar   -- ^ extname
    -> IO ALboolean

foreign import CALLCV "alGetProcAddress"
  alGetProcAddress
    :: Ptr ALchar    -- ^ fname
    -> IO (FunPtr a)

foreign import CALLCV "alGetEnumValue"
  alGetEnumValue
    :: Ptr ALchar -- ^ ename
    -> IO ALenum
...
foreign import CALLCV "alListenerf"
  alListenerf
    :: ALenum  -- ^ param
    -> ALfloat -- ^ value
    -> IO ()

foreign import CALLCV "alListener3f"
  alListener3f
    :: ALenum  -- ^ param
    -> ALfloat -- ^ value1
    -> ALfloat -- ^ value2
...
foreign import CALLCV "alListenerfv"
  alListenerfv
    :: ALenum      -- ^ param
    -> Ptr ALfloat -- ^ values
    -> IO ()

foreign import CALLCV "alListeneri"
  alListeneri
    :: ALenum -- ^ param
    -> ALint  -- ^ value
    -> IO ()

foreign import CALLCV "alListener3i"
  alListener3i
    :: ALenum -- ^ param
    -> ALint  -- ^ value1
    -> ALint  -- ^ value2
...
foreign import CALLCV "alListeneriv"
  alListeneriv
    :: ALenum    -- ^ param
    -> Ptr ALint -- ^ values
    -> IO ()

foreign import CALLCV "alGetListenerf"
  alGetListenerf
    :: ALenum      -- ^ param
    -> Ptr ALfloat -- ^ value
    -> IO ()

foreign import CALLCV "alGetListener3f"
  alGetListener3f
    :: ALenum      -- ^ param
    -> Ptr ALfloat -- ^ value1
    -> Ptr ALfloat -- ^ value2
...
foreign import CALLCV "alGetListenerfv"
  alGetListenerfv
    :: ALenum      -- ^ param
    -> Ptr ALfloat -- ^ values
    -> IO ()

foreign import CALLCV "alGetListeneri"
  alGetListeneri
    :: ALenum    -- ^ param
    -> Ptr ALint -- ^ value
    -> IO ()

foreign import CALLCV "alGetListener3i"
  alGetListener3i
    :: ALenum    -- ^ param
    -> Ptr ALint -- ^ value1
    -> Ptr ALint -- ^ value2
...
foreign import CALLCV "alGetListeneriv"
  alGetListeneriv
    :: ALenum    -- ^ param
    -> Ptr ALint -- ^ values
    -> IO ()
...
foreign import CALLCV "alGenSources"
  alGenSources
    :: ALsizei    -- ^ n
    -> Ptr ALuint -- ^ source
    -> IO ()
...
foreign import CALLCV "alDeleteSources"
  alDeleteSources
    :: ALsizei    -- ^ n
    -> Ptr ALuint -- ^ sources
    -> IO ()
...
foreign import CALLCV "alIsSource"
  alIsSource
    :: ALuint -- ^ sid
    -> IO ALboolean

foreign import CALLCV "alSourcef"
  alSourcef
    :: ALuint  -- ^ sid
    -> ALenum  -- ^ param
    -> ALfloat -- ^ value
...
foreign import CALLCV "alSource3f"
  alSource3f
    :: ALuint  -- ^ sid
    -> ALenum  -- ^ param
    -> ALfloat -- ^ value1
...
foreign import CALLCV "alSourcefv"
  alSourcefv
    :: ALuint      -- ^ sid
    -> ALenum      -- ^ param
    -> Ptr ALfloat -- ^ values
...
foreign import CALLCV "alSourcei"
  alSourcei
    :: ALuint -- ^ sid
    -> ALenum -- ^ param
    -> ALint  -- ^ value
...
foreign import CALLCV "alSource3i"
  alSource3i
    :: ALuint -- ^ sid
    -> ALenum -- ^ param
    -> ALint  -- ^ value1
...
foreign import CALLCV "alSourceiv"
  alSourceiv
    :: ALuint    -- ^ sid
    -> ALenum    -- ^ param
    -> Ptr ALint -- ^ values
...
foreign import CALLCV "alGetSourcef"
  alGetSourcef
    :: ALuint      -- ^ sid
    -> ALenum      -- ^ param
    -> Ptr ALfloat -- ^ value
...
foreign import CALLCV "alGetSource3f"
  alGetSource3f
    :: ALuint      -- ^ sid
    -> ALenum      -- ^ param
    -> Ptr ALfloat -- ^ value1
...
foreign import CALLCV "alGetSourcefv"
  alGetSourcefv
    :: ALuint      -- ^ sid
    -> ALenum      -- ^ param
    -> Ptr ALfloat -- ^ values
...
foreign import CALLCV "alGetSourcei"
  alGetSourcei
    :: ALuint    -- ^ sid
    -> ALenum    -- ^ param
    -> Ptr ALint -- ^ value
...
foreign import CALLCV "alGetSource3i"
  alGetSource3i
    :: ALuint    -- ^ sid
    -> ALenum    -- ^ param
    -> Ptr ALint -- ^ value1
...
foreign import CALLCV "alGetSourceiv"
  alGetSourceiv
    :: ALuint    -- ^ sid
    -> ALenum    -- ^ param
    -> Ptr ALint -- ^ values
...
foreign import CALLCV "alSourcePlayv"
  alSourcePlayv
    :: ALsizei    -- ^ ns
    -> Ptr ALuint -- ^ sids
    -> IO ()
...
foreign import CALLCV "alSourceStopv"
  alSourceStopv
    :: ALsizei    -- ^ ns
    -> Ptr ALuint -- ^ sids
    -> IO ()
...
foreign import CALLCV "alSourceRewindv"
  alSourceRewindv
    :: ALsizei    -- ^ ns
    -> Ptr ALuint -- ^ sids
    -> IO ()
...
foreign import CALLCV "alSourcePausev"
  alSourcePausev
    :: ALsizei    -- ^ ns
    -> Ptr ALuint -- ^ sids
    -> IO ()
...
foreign import CALLCV "alSourcePlay"
  alSourcePlay
    :: ALuint -- ^ sid
    -> IO ()

-- | Stop a Source
foreign import CALLCV "alSourceStop"
  alSourceStop
    :: ALuint -- ^ sid
    -> IO ()

-- | Rewind a Source (set playback postiton to beginning)
foreign import CALLCV "alSourceRewind"
  alSourceRewind
    :: ALuint -- ^ sid
    -> IO ()

-- | Pause a Source
foreign import CALLCV "alSourcePause"
  alSourcePause
    :: ALuint -- ^ sid
    -> IO ()

foreign import CALLCV "alSourceQueueBuffers"
  alSourceQueueBuffers
    :: ALuint     -- ^ sid
    -> ALsizei    -- ^ numEntries
    -> Ptr ALuint -- ^ bids
...
foreign import CALLCV "alSourceUnqueueBuffers"
  alSourceUnqueueBuffers
    :: ALuint     -- ^ sid
    -> ALsizei    -- ^ numEntries
    -> Ptr ALuint -- ^ bids
...
foreign import CALLCV "alGenBuffers"
  alGenBuffers
    :: ALsizei    -- ^ n
    -> Ptr ALuint -- ^ buffers
    -> IO ()
...
foreign import CALLCV "alDeleteBuffers"
  alDeleteBuffers
    :: ALsizei    -- ^ n
    -> Ptr ALuint -- ^ buffers
    -> IO ()
...
foreign import CALLCV "alIsBuffer"
  alIsBuffer
    :: ALuint       -- ^ bid
    -> IO ALboolean

-- | Specify the data to be copied into a buffer
foreign import CALLCV "alBufferData"
  alBufferData
    :: ALuint     -- ^ bid
    -> ALenum     -- ^ format
    -> Ptr ALvoid -- ^ data
...
foreign import CALLCV "alBufferf"
  alBufferf
    :: ALuint  -- ^ bid
    -> ALenum  -- ^ param
    -> ALfloat -- ^ value
...
foreign import CALLCV "alBuffer3f"
  alBuffer3f
    :: ALuint  -- ^ bid
    -> ALenum  -- ^ param
    -> ALfloat -- ^ value1
...
foreign import CALLCV "alBufferfv"
  alBufferfv
    :: ALuint      -- ^ bid
    -> ALenum      -- ^ param
    -> Ptr ALfloat -- ^ values
...
foreign import CALLCV "alBufferi"
  alBufferi
    :: ALuint -- ^ bid
    -> ALenum -- ^ param
    -> ALint  -- ^ value
...
foreign import CALLCV "alBuffer3i"
  alBuffer3i
    :: ALuint -- ^ bid
    -> ALenum -- ^ param
    -> ALint  -- ^ value1
...
foreign import CALLCV "alBufferiv"
  alBufferiv
    :: ALuint    -- ^ bid
    -> ALenum    -- ^ param
    -> Ptr ALint -- ^ values
...
foreign import CALLCV "alGetBufferf"
  alGetBufferf
    :: ALuint      -- ^ bid
    -> ALenum      -- ^ param
    -> Ptr ALfloat -- ^ value
...
foreign import CALLCV "alGetBuffer3f"
  alGetBuffer3f
    :: ALuint      -- ^ bid
    -> ALenum      -- ^ param
    -> Ptr ALfloat -- ^ value1
...
foreign import CALLCV "alGetBufferfv"
  alGetBufferfv
    :: ALuint      -- ^ bid
    -> ALenum      -- ^ param
    -> Ptr ALfloat -- ^ values
...
foreign import CALLCV "alGetBufferi"
  alGetBufferi
    :: ALuint    -- ^ bid
    -> ALenum    -- ^ param
    -> Ptr ALint -- ^ value
...
foreign import CALLCV "alGetBuffer3i"
  alGetBuffer3i
    :: ALuint    -- ^ bid
    -> ALenum    -- ^ param
    -> Ptr ALint -- ^ value1
...
foreign import CALLCV "alGetBufferiv"
  alGetBufferiv
    :: ALuint    -- ^ bid
    -> ALenum    -- ^ param
    -> Ptr ALint -- ^ values
...
foreign import CALLCV "alDopplerFactor"
  alDopplerFactor
    :: ALfloat -- ^ value
    -> IO ()

foreign import CALLCV "alDopplerVelocity"
  alDopplerVelocity
    :: ALfloat -- ^ value
    -> IO ()

foreign import CALLCV "alSpeedOfSound"
  alSpeedOfSound
    :: ALfloat -- ^ value
    -> IO ()

foreign import CALLCV "alDistanceModel"
  alDistanceModel
